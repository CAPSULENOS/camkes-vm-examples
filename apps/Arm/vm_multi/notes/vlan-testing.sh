...
ovs-ofctl add-flow br0 "arp,in_port=eth1,dl_vlan=3009,action=mod_vlan_vid=90,NORMAL"
...
ovs-ofctl add-flow br0 arp,dl_vlan=3000,action=mod_vlan_vid=2,NORMAL
ovs-ofctl add-flow br0 in_port=eth1,dl_vlan=3000,actions=mod_vlan_vid=2,output=eth0

/connect-vlans --uni --vid1 3 --vid2 4
/connect-vlans --uni --vid1 4 --vid2 5
/connect-vlans --uni --vid1 6 --vid2 3000
ovs-ofctl add-flow br0 arp,dl_vlan=6,action=mod_vlan_vid=3000,NORMAL
ovs-ofctl add-flow br0 in_port=eth1,dl_vlan=6,actions=mod_vlan_vid=3000,output=eth0

ovs-ofctl add-flow br0 arp,dl_vlan=3001,action=mod_vlan_vid=7,NORMAL
ovs-ofctl add-flow br0 in_port=eth1,dl_vlan=3001,actions=mod_vlan_vid=7,output=eth0
/connect-vlans --uni --vid1 7 --vid2 3001
ovs-ofctl add-flow br0 arp,dl_vlan=7,action=mod_vlan_vid=3001,NORMAL
ovs-ofctl add-flow br0 in_port=eth1,dl_vlan=7,actions=mod_vlan_vid=3001,output=eth00
